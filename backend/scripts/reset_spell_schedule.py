...
示例:
  # Dry run 模式（仅查看，不修改）
  python backend/scripts/reset_spell_schedule.py --dry-run

  # 实际执行更新
  python backend/scripts/reset_spell_schedule.py

  # 自定义起始日期和每日单词数
  python backend/scripts/reset_spell_schedule.py --start-date 2025-10-20 --words-per-day 200

  # 只处理特定来源
  python backend/scripts/reset_spell_schedule.py --source IELTS
        """,
    )
