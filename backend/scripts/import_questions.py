...
PART1_FILE_PATH = BASE_DIR + "/backend/data/questions/speaking_questions_part1.txt"
PART2_FILE_PATH = BASE_DIR + "/backend/data/questions/speaking_questions_part2&3.txt"
