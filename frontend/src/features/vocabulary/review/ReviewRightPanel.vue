<template>
  ...
  <div class="review-right-panel" :class="{ 'is-mobile': isMobile }">
    <!-- ═══════════════════════════════════════════════════════════════════════════
         桌面端：固定右侧面板
         ═══════════════════════════════════════════════════════════════════════════ -->
...
// Computed
const breakdown = computed(() => props.notificationData?.breakdown)
