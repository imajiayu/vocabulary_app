/**
 * 词汇学习助手 Prompt（按词源语言区分）
 * 由 shared/api/vocabulary-assistance.ts 消费
 *
 * 占位符（调用方用 .replace() 填充）：{word}, {definition}
 */

import type { SourceLang } from '@/shared/types'

/** IELTS 英语词汇助手 */
export const EN_PROMPT = `你是 IELTS 词汇学习助手，帮助用户理解和记忆词汇。
...
/** 乌克兰语词汇助手 */
export const UK_PROMPT = `你是乌克兰语词汇学习助手，帮助中文母语用户理解和记忆乌克兰语词汇。
...
export const VOCABULARY_ASSISTANCE_PROMPTS: Record<SourceLang, string> = {
  en: EN_PROMPT,
  uk: UK_PROMPT,
}
